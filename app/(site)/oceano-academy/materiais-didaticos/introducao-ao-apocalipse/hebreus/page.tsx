    ...
    <section className="relative backdrop-blur-sm">
      ...
      <HeroContainer className="pb-2 sm:pb-0">
        <div className="flex flex-col gap-2">
          ...
          <P className="mt-0">
            A supremacia e suficiência de Cristo: sacerdote eterno, sacrifício
            perfeito e âncora da fé.
          </P>
        </div>
      </HeroContainer>
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            plenamente em sua supremacia, descansando em sua obra e testemunhando
            sua glória em cada área da nossa vida.
          </P>
        </div>
      </Container>
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            graça para socorro em ocasião oportuna&quot; (Hb 4.15-16, ARA).
          </P>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            trabalho e do amor que evidenciastes para com o seu nome&quot; (Hb 6.10,
            ARA).
          </P>
          <P className="">
          ...
          <P className="">
            ...
            em meio às advertências, há um convite à perseverança. O cristão deve
            levar a vida espiritual com seriedade, evitando a preguiça e buscando
            maturidade na fé. Ao mesmo tempo, deve viver com confiança na
            fidelidade de Deus, mantendo firme a esperança que é âncora da alma.
          </P>
        </div>
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            14.18-20). O autor destaca que ele era maior que Abraão, pois recebeu
            dele o dízimo. Assim, o sacerdócio de Cristo é comparado ao de
            Melquisedeque, não baseado em genealogia, mas em poder eterno.
          </P>
          <P className="">
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            compaixão pelos presos, à pureza no casamento, à vida sem avareza e à
            confiança em Deus.
          </P>
          <P className="">
