...
Paulo inicia apresentando-se como "servo de Deus e apóstolo de Jesus Cristo" (Tt 1.1). Essa dupla designação mostra tanto sua humildade como sua autoridade. O termo "servo" (_doulos_) indica submissão total, enquanto "apóstolo" mostra o chamado direto de Cristo. MacArthur (2015) observa que Paulo poderia destacar seus privilégios e experiências extraordinárias, mas preferiu identificar-se, acima de tudo, como servo de Deus.
...
Paulo deixou Tito em Creta para pôr em ordem as coisas restantes e estabelecer presbíteros em cada cidade (Tt 1.5). A expressão "pôr em ordem" (_epidiorthōsē_) transmite a ideia de completar o que ainda estava incompleto, como um médico que endireita um osso quebrado. Isso mostra que o trabalho de Tito era pastoral e corretivo.
