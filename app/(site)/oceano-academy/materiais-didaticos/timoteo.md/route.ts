...
Apesar disso, ainda há doutrinas que ensinam múltiplos mediadores — sejam santos, anjos ou figuras religiosas. Tais ideias, porém, contrariam as Escrituras. A fé reformada insiste: _solus Christus_ — somente Cristo. Ele é o único capaz de nos representar diante do Pai.
...
A palavra grega _epískopos_ significa "supervisor", "pastor" ou "ancião". No Novo Testamento, esses termos se referem à mesma função (At 20:17,28). O episcopado, portanto, é um chamado ao cuidado do rebanho.
...
O serviço diaconal surge em Atos 6, quando os apóstolos designam homens para cuidar das viúvas e da distribuição de alimentos (At 6:1-3). A palavra diácono vem do grego _diakonos_, que significa "servo", "ministro" ou "ajudante".
