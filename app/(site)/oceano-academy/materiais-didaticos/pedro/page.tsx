...
export const metadata = {
  alternates: {
    types: {
      "text/markdown": "/oceano-academy/materiais-didaticos/pedro.md",
    },
  },
};
  ...
  return (
    <section className="relative backdrop-blur-sm">
      ...
      <HeroContainer className="pb-2 sm:pb-0">
        ...
        <HeroImage
          src="/images/oceano-academy/materiais-didaticos/pedro/pedro-cover.webp"
          alt="As Cartas de Pedro"
        />
      </HeroContainer>
        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent">
              ...
              <TableCell>
                <TableCellLinksContainer>
                  ...
                  <LinkSmall href="/oceano-academy/materiais-didaticos/pedro.md">
            ...
            <TableRow className="hover:bg-transparent">
              ...
              <TableCell>
                <TableCellLinksContainer>
                  <LinkSmall href="https://drive.google.com/file/d/1eKN8ABnHJlTcaci79IvP1ZGchzX7Oo3M/view?usp=sharing">
                    <FileText className="size-4" />
                    Plano de Estudo
                  </LinkSmall>
                </TableCellLinksContainer>
            ...
            <TableRow className="hover:bg-transparent">
              ...
              <TableCell>
                <TableCellLinksContainer>
                  <LinkSmall href="https://www.youtube.com/watch?v=ckVR3YJUTXY">
                    <SquarePlay className="size-4" />1 Pedro
                  </LinkSmall>
