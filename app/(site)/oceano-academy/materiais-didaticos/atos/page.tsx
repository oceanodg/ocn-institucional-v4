...
export const metadata = {
  alternates: {
    types: {
      "text/markdown": "/oceano-academy/materiais-didaticos/atos.md",
    },
  },
};
  ...
  return (
    <section className="relative backdrop-blur-sm">
      ...
      <HeroContainer className="pb-2 sm:pb-0">
        ...
        <HeroImage
          src="/images/oceano-academy/materiais-didaticos/atos/atos-cover.webp"
          alt="Atos dos Apóstolos"
        />
      </HeroContainer>
            ...
            <TableRow className="hover:bg-transparent">
              ...
              <TableCell>
                <TableCellLinksContainer>
                  <LinkSmall href="https://drive.google.com/file/d/1hxws88uPWOOF70X8MRp9NZRzecX_TFDp/view?usp=sharing">
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <UL className="mt-0 space-y-2 sm:space-y-2">
          ...
          <SummaryLi subList>
            <a href="#lesson-1-o-autor-de-atos">Tópico 1: O Autor de Atos</a>
          </SummaryLi>
          <SummaryLi subList>
          ...
          <SummaryLi>
            <a href="#lesson-3">Lição 3 – Os Fundamentos da Missão Mundial</a>
          </SummaryLi>
          <SummaryLi subList>
          ...
          <SummaryLi subList>
            <a href="#lesson-4-missoes">Tópico 3: Missões (Atos 16:6-21:17)</a>
          </SummaryLi>
          <SummaryLi subList>
            <a href="#lesson-4-roma">Tópico 4: Roma (Atos 21:18-28:31)</a>
          </SummaryLi>
          <SummaryLi subList>
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            O Livro de Atos é o volume 2 do relato de Lucas sobre as &quot;boas
            novas&quot; de Jesus e como elas se espalharam de Jerusalém a Roma
            pelo poder do Espírito. Henry J. Cadbury (1958) considera que Atos
            não é apenas um apêndice ou um posfácio, mas uma obra única e
            contínua com o seu Evangelho. Lucas o escreveu como um diplomata,
            historiador e teólogo-evangelista. Se este livro não se encontrasse
            na Bíblia, teríamos poucas informações sobre os primórdios da
            igreja, com exceção do que encontramos nas cartas de Paulo, por
            exemplo, e nas de Pedro.
          </P>
          <P className="">
            Recebemos 4 relatos sobre a vida de Jesus nos evangelhos, mas
            somente 1 sobre a igreja primitiva. Atos, portanto, ocupa um lugar
            de extrema notoriedade pois, sem ele, por exemplo, provavelmente não
          ...
          <P className="">
            Geralmente falamos &quot;Atos dos Apóstolos&quot;, entretanto ele
            não nos fornece um relatório extenso dos apóstolos. Com exceção de
            Paulo, somente outros 3 são mencionados com maior destaque: Tiago
            (irmão de João), João, o qual aparece na narrativa, mas nunca fala,
            e Pedro. Outro aspecto característico de Atos é que, para se
            entender este livro, necessitamos reconhecer o &quot;movimento&quot;
            do evangelho narrado em 6 partes:
          </P>
          <P className="">
          ...
          <P className="">
            ...
            primeiros líderes tiveram que lidar com a &quot;problemática&quot;
            da inclusão dos gentios;
          </P>
          <P className="">
          ...
          <P className="">
            ...
            histórico em que foi escrito, entendemos que seu conteúdo é
            relevante e aplicável aos crentes de hoje. As experiências e
            práticas descritas no livro de Atos servem como modelo para a igreja
            contemporânea, especialmente no que se refere à atuação do Espírito
            Santo e à prática dos dons espirituais. Por exemplo, ao refletirmos
            sobre a escolha de Matias para substituir Judas (Atos 1:23-26),
            vemos a importância de buscar a direção de Deus em decisões
            importantes na igreja, confiando que o Espírito Santo guia Seu povo.
          </P>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            Em vista disso, podemos afirmar que Lucas era um médico e
            companheiro de Paulo, pois estava com este durante o seu último
            aprisionamento. Além disso, também conseguimos concluir que Lucas
            era gentio porquanto em Colossenses 4:11 conclui-se uma lista de
            menções e saudações daqueles que eram da &quot;circuncisão&quot;, ou
            seja, judeus. No próximo versículo é estabelecido uma nova lista e,
            inferimos, que seja de gentios, uma vez que seu nome é incluído no
            versículo 14, com a certeza de que ele não se encontra na lista de
            pessoas &quot;da circuncisão&quot;. Desta forma, chegamos à
            conclusão de que Lucas é o único autor gentio no Novo Testamento.
          </P>
          <P className="">
            Quanto ao fato de Lucas ser um médico, como citado em Colossenses
            4:14, poderíamos predizer este fato devido aos termos médicos que
            ele usa. Por exemplo, em Lucas 4:35: &quot;Mas Jesus o repreendeu,
            ...
            mal.&quot; Neste versículo ele usa o termo médico de convulsão. Já
            em Lucas 9:38: &quot;E eis que, do meio da multidão, surgiu um
            homem, dizendo em alta voz: — Mestre, peço que o senhor olhe o meu
            filho, porque é o único que tenho.&quot; O autor desta vez usa a
            palavra convencional de um médico que está atendendo a um paciente
            quando expressa &quot;peço que o senhor olhe o meu filho&quot;.
          </P>
          <P className="">
            Um outro exemplo curioso seria Lucas 18:25: &quot;Porque é mais
            fácil um camelo passar pelo fundo de uma agulha do que um rico
            entrar no Reino de Deus.&quot; Diferentemente de Mateus 19:24 e
            Marcos 10:25, Lucas usa o termo técnico no grego <em>belone</em>,
            que significa a agulha de um cirurgião, enquanto os outros
            evangelhos apresentam o grego <em>raphis</em>, vocábulo comum para
            &quot;agulha&quot; de alfaiate. Os médicos se submetiam a um
            treinamento rigoroso naqueles tempos e pode-se perceber o grego
            refinado de Lucas, atestando que o mesmo era uma pessoa culta. Além
            de ser médico e amigo de Paulo, ele também morou na Palestina e,
            podemos inferir, que o autor passou um tempo se familiarizando com
            as histórias e costumes judeus, coletando material para seus livros.
          </P>
          <P className="">
          ...
          <P className="">
            ...
            incluído nesta seção, pois sua narração passa da terceira pessoa
            para &quot;nós&quot;. Ele provavelmente deve ter mantido um diário
            de viagem, no qual escrevia os acontecimentos do dia. As passagens
            em que ele escreve &quot;nós&quot; são as seguintes: 16:10-17,
            20:5-16, 21:1-18 e 27:1-28:16. Lucas deve ter estado presente em
            todos esses acontecimentos, sendo testemunha ocular. Quanto aos
            eventos em que estava ausente, ele pôde coletar informações para seu
            livro nas muitas horas em que passou com Paulo na prisão.
          </P>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            evangelho de Lucas quanto Atos foram escritos para um homem cujo
            nome era Teófilo (Lucas 1:3; Atos 1:1). Devido ao fato de Lucas o
            chamar de &quot;excelentíssimo Teófilo&quot;, pode-se concluir que
            ele era de um alto escalão do governo romano. Porém, existem 3
            possibilidades sobre a identidade de Teófilo:
          </P>
          <P className="">
            1. Possivelmente, Teófilo não seria um nome real pois naqueles
            tempos era considerado perigoso ser cristão. O nome em si vem de
            duas palavras no grego: <em>Theo</em> (Deus) e <em>philos</em>{" "}
            (amigo). Hipoteticamente, Lucas teria escrito para alguém que amava
            Deus, mas escondeu a sua verdadeira identidade por segurança.
          </P>
          <P className="">
            2. Outra probabilidade é a de que Teófilo era uma pessoa real, um
            funcionário importante do governo. Talvez Lucas estivesse
            endereçando seus livros a ele para mostrá-lo como o Cristianismo é
            algo benéfico e que os cristãos eram boas pessoas. Supostamente ele
            estaria escrevendo para um oficial do governo não perseguir a
            igreja.
          </P>
          <P className="">
            ...
            Entretanto, pela expertise e devoção de Lucas, ele tenha sido
            curado, o que levaria Teófilo a dar a Lucas sua liberdade. Por outro
            lado, ele teria escrito os livros a ele como forma de gratidão e,
            como o que ele tinha mais de precioso naquela época era a história
            de Jesus, ele a escreveu e a enviou a seu benfeitor.
          </P>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            Testamento. É importante salientar que o autor não enxerga o volume
            1 como sendo a história de Jesus Cristo desde o seu nascimento,
            ...
            conquista de Roma. O contraste que ele expõe não ocorre entre Jesus
            e sua igreja, mas entre as duas etapas do ministério de Cristo.
          </P>
          <P className="">
          ...
          <P className="">
            John Stott questiona qual seria, então, o nome correto para o
            segundo volume de Lucas? O Codex Sinaiticus, do quarto século, o
            intitula de <em>Praxeis</em> (&quot;Atos&quot;). Porém, não há uma
            explicação de quem seriam esses atos que ele está descrevendo. O
            título tradicional desde o segundo século é &quot;Os Atos dos
          ...
          <P className="">
            <em>
              Podemos, talvez, nos aventurar a chamar este livro de &quot;Os
              Atos do Espírito Santo&quot;, pois, do começo ao fim, ele é o
              registro de seu advento e atividade. Aqui ele é visto chegando e
              operando... Só se reconhece um único Ator e Agente verdadeiro,
              todos os outros, chamados atores ou trabalhadores, são apenas seus
              instrumentos, o agente sendo o que atua e o instrumento, aquilo
              através do qual ele atua.
            </em>
          </P>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-1-a-mensagem-central">Tópico 4: A Mensagem Central</H3>
          <P className="">
            ...
            edifica a igreja e possibilita a propagação do evangelho a partir
            dos judeus para os gentios. Desta forma, os cristãos têm o bom senso
            de trabalhar junto com Deus para incluir os gentios em Sua salvação.
            A salvação é para todos e nada pode impedi-la. As boas novas são
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            Podemos concluir de que Atos é um livro importante para entendermos
            a história dos primórdios da igreja. Lucas possuiu todas as
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            promessa de Jesus na qual Ele &quot;derramaria&quot; O Espírito
            Santo sobre os seus discípulos. Esta é a última obra da função
            salvífica de Cristo (até a sua segunda vinda). Como os profetas
            haviam profetizado, o encerramento da carreira dO Filho do Homem na
            Terra também marcaria um novo começo.
          </P>
          <P className="">
            ...
            novas&quot; a todas as nações. A salvação foi dada a eles pela
            graça, mas ela também precisa ser compartilhada.
          </P>
          <P className="">
            Entretanto, antes do dia de Pentecostes acontecer, os cristãos
            passaram por um período de espera, quarenta dias entre a
            ressurreição e a ascensão dO Messias, e mais dez dias entre a
            ascensão e o Pentecostes. Com orientações bem claras, Lucas faz
            questão de incluí-las no final do seu Evangelho e no início de Atos:
          </P>
          <P className="">
            <em>
              Eis que envio sobre vós a promessa de meu Pai; permanecei, pois,
              na cidade, até que do alto sejais revestidos de poder. (Lucas
              24:49)
            </em>
          </P>
          <P className="">
            <em>
              ...
              ele, de mim ouvistes. Porque João, na verdade, batizou com água,
              mas vós sereis batizados com o Espírito Santo, não muito depois
              destes dias. (Atos 1:4-5)
            </em>
          </P>
          <P className="">
            Porém, os discípulos não ficaram ociosos durante os cinquenta dias
            de espera do Pentecostes. O autor de Atos faz uma descrição de 4
            eventos valiosos:
          </P>
          <P className="">
          ...
          <P className="">
            ...
            comissionados para testemunhar, após Jesus ter sido elevado às
            alturas e a vinda do Espírito para os capacitar.
          </P>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            <em>
              Então os que estavam reunidos com Jesus lhe perguntaram: — Será
              este o tempo em que o Senhor irá restaurar o reino a Israel? Jesus
          ...
          <P className="">
            Em segundo lugar, O Messias explana sobre o fato de que os
            discípulos deveriam aguardar a vinda do Espírito Santo. Portanto, os
            dois assuntos primordiais entre a ressurreição de Jesus e sua
            ascensão foram o reino de Deus e Seu Espírito. Possivelmente, O
            Cristo tenha explicado sobre a relação entre ambos, pois os profetas
            do Antigo Testamento muitas vezes os associaram um ao outro.
          </P>
          <P className="">
            Ao perguntarem &quot;
            <em>
            ...
            &quot;, os discípulos cometeram o erro de confundir a natureza do
            reino e a relação entre o reino e o Espírito. A confusão se dá pois
            eles estavam esperando um reino político, nacional e de restauração
            imediata. Jesus faz a correção do pensamento deles quanto à
            natureza, extensão e chegada do reino nos versículos 7-8 de Atos 1:
          </P>
          <P className="">
          ...
          <P className="">
            A resposta de Jesus nos remete ao Espírito Santo, porquanto falou
            que o Espírito viria sobre eles, dando-lhes poder. A atividade do
            &quot;poder&quot; é intrínseca ao conceito de Reino. Todavia, o
            poder do Reino é diferente do poder dos reinos terrestres. O Reino
            de Deus são os seus mandamentos instituídos na vida dos Cristãos
            através do Espírito Santo. Mediante uma mensagem de paz e não de
            guerra, pela atuação do Espírito e não pela força de armas. No
            entanto, não podemos cair no erro de espiritualizar o reino em
            excesso como se ele operasse somente no céu e não na terra. Apesar
            de o reino não ser um programa político, ele possui implicações
            políticas e sociais radicais, pois seus valores entram em contraste
            com os valores seculares. Os seguidores negam a César a lealdade
            suprema e concedem-na somente a Jesus.
          </P>
          <P className="">
          ...
          <P className="">
            ...
            concederia poder de serem suas testemunhas, começando em Jerusalém,
            a capital nacional e lugar da condenação e crucificação dO Messias,
            até os confins da terra. A tese de Johannes Blauw é de que a
            concepção do Antigo Testamento compreenderia uma preocupação com as
            nações (Deus as criou e elas se curvarão diante dEle), mas não uma
            missão às nações (sair para conquistá-las).
          </P>
          <P className="">
          ...
          <P className="">
            ...
            pontos. Primeiramente, &quot;
            <em>
              Não cabe a vocês conhecer tempos ou épocas que o Pai fixou pela
              sua própria autoridade
            </em>
            &quot;. Tempos (<em>chronoi</em>) ou épocas (<em>kairoi</em>),
            juntos, constituem o plano de Deus. O questionamento sugere
            curiosidade ou impaciência, ou ambas. Porém, o Filho afirma que não
            sabia o dia nem a hora de sua volta (<em>parousia</em>). Desta
            forma, os apóstolos são forçados a permanecer na ignorância, pois os
            mistérios pertencem a Deus e as coisas reveladas nos competem e
            devemos ficar contentes com elas.
          </P>
          <P className="">
            Em segundo lugar, embora eles não estivessem aptos a conhecer os
            tempos e as épocas, eles necessitavam estar cientes de que
            receberiam poder para que, no período entre a vinda do Espírito e a
            segunda vinda de Cristo, pudessem ser suas testemunhas. Os
            seguidores de Jesus devem propagar o evangelho até a sua segunda
            vinda, testemunhas até aos confins da terra e até a consumação do
            século.
          </P>
          <P className="">
          ...
          <P className="">
            <em>
              ...
              Oliveiras para Jerusalém. A distância até a cidade é de cerca de
              um quilômetro. (Atos 1:9-12)
            </em>
          </P>
          <P className="">
            Somente os onze apóstolos viram Jesus ascender aos céus, mas em
            certo momento da segunda vinda todo o olho verá. Ao invés de voltar
            sozinho (como ascendeu), milhões de santos - humanos e angelicais -
            constituirão uma comitiva. E, ao contrário de ser uma volta
            exclusiva a um local (&quot;Lá está!&quot; ou &quot;Ei-lo
            aqui!&quot;), será &quot;assim como relâmpago, fuzilando, que brilha
            de uma à outra extremidade do céu&quot;.
          </P>
          <P className="">
            <strong>1.3 Eles oraram pela chegada dO Espírito (1:12-14)</strong>
          </P>
          <P className="">
            <em>
              ...
              perseveravam unânimes em oração, com as mulheres, com Maria, mãe
              de Jesus, e com os irmãos dele. (Atos 1:12-14)
            </em>
          </P>
          <P className="">
          ...
          <P className="">
            ...
            usado mais tarde por Lucas quando ele se refere aos novos
            convertidos que &quot;perseveravam na doutrina dos apóstolos&quot;
            (Atos 2:42) e aos apóstolos que priorizam a oração e pregação (Atos
            6:4). O fundamento dessa união e perseverança em oração é o
            mandamento e a promessa de Jesus. Portanto, concluímos que as
            promessas de Deus não tornam nossas orações supérfluas, mas elas nos
            dão a garantia para orarmos e a confiança de que Ele ouvirá e
            responderá.
          </P>
          <P className="">
            <strong>
          ...
          <P className="">
            <em>
              ...
              um grupo de mais ou menos cento e vinte pessoas, e disse: —
              Irmãos, era necessário que se cumprisse a Escritura que o Espírito
              Santo predisse pela boca de Davi, a respeito de Judas, que foi o
              guia daqueles que prenderam Jesus. Ele era um dos nossos e teve
              parte neste ministério. Ora, este homem adquiriu um campo com o
              preço da iniquidade e, caindo de cabeça, rompeu-se pelo meio, e
              todos os seus intestinos se derramaram. Isto chegou ao
              conhecimento de todos os moradores de Jerusalém, de maneira que em
              sua própria língua esse campo era chamado Aceldama, isto é, Campo
              de Sangue. E Pedro continuou: — Porque está escrito no Livro dos
              Salmos: &quot;Fique deserta a sua morada, e não haja quem nela
              habite.&quot; — E: &quot;Que outro tome o seu encargo.&quot; —
              Portanto, é necessário que, dos homens que nos acompanharam todo o
              tempo em que o Senhor Jesus andou entre nós, começando no batismo
              de João, até o dia em que foi tirado do nosso meio e levado às
              alturas, um destes se torne testemunha conosco da sua
              ressurreição. Então propuseram dois: José, chamado Barsabás,
              também conhecido como Justo, e Matias. E, orando, disseram: — Tu,
              Senhor, que conheces o coração de todos, revela-nos qual dos dois
              escolheste para preencher a vaga neste ministério e apostolado, do
              qual Judas se desviou, indo para o seu próprio lugar. Depois
              fizeram um sorteio, e a sorte caiu sobre Matias, que foi
              acrescentado ao grupo dos onze apóstolos. (Atos 1:15-26)
            </em>
          </P>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            como o Espírito veio sobre Jesus quando este foi batizado, também
            foi guiado por ele, no poder dele e ungido por ele, agora era a vez
            dos discípulos o receberem para serem capacitados para a missão
            mundial. O Pentecostes foi o cumprimento da promessa de Jesus para
            lhes ensinar e lembrar de Seus ensinos.
          </P>
          <P className="">
            A festa de Pentecostes possuía dois significados: um agrícola e
            outro histórico. Sendo a segunda das três festas anuais para
            comemorar a ceifa, era chamada de &quot;Festa da Colheita&quot;,
            pois era o fim da colheita dos cereais, ou &quot;Festa das
            Semanas&quot;, por acontecer sete semanas ou 50 dias após a páscoa.{" "}
            <em>Pentekostos</em> é definido como &quot;quinquagésimo&quot;.
            Perto do fim do período intertestamentário, começou-se a ser
            comemorada como aniversário da entrega da lei no Monte Sinai, pois
            foram 50 dias após o Êxodo.
          </P>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            ao povo sobre as &quot;boas novas&quot;. Mas os sacerdotes, o
            capitão do templo e os saduceus, ressentidos por pregarem Jesus
            ressuscitado dentre os mortos, prenderam estes discípulos e os
            recolheram ao cárcere até o dia seguinte. Entretanto, muitos creram,
            subindo a quase 5 mil o número de convertidos.
          </P>
          <P className="">
            Lucas aponta que ambas as ondas de perseguição tiveram seu início
            com os saduceus (Atos 4:1 e 5:17). Mas quem eram os saduceus? Eles
            eram a classe governante dos aristocratas ricos, integrados ao
            sistema romano e temiam o ensino revolucionário dos apóstolos.
            Acreditavam que a era messiânica foi iniciada na era dos macabeus e,
            por isso, não estavam à espera de um messias. Também não aceitavam a
            ressurreição dos mortos e viam os apóstolos como agitadores e
            perturbadores da lei. Entretanto, Lucas nos lembra de que a
            perseguição não impediu a propagação do Evangelho, pois eles
            poderiam prender os apóstolos, mas não as &quot;boas novas&quot; e
            subiu em quase 5 mil o número de cristãos naquele dia.
          </P>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">Satanás atacou a igreja em 3 frentes:</P>
          <P className="">
          ...
          <P className="">
            <em>
              Naqueles dias, aumentando o número dos discípulos, houve
              ...
              correto que nós abandonemos a palavra de Deus para servir às
              mesas. Por isso, irmãos, escolham entre vocês sete homens de boa
              reputação, cheios do Espírito e de sabedoria, para os
              encarregarmos desse serviço. Quanto a nós, nos consagraremos à
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            estavam ociosos e que a oração era unânime. Portanto, as promessas
            de Deus nos estimulam a orar. O dia de Pentecostes é marcado pelo
          ...
          <P className="">
            ...
            pelos saduceus, pois rejeitavam a ressurreição dos mortos e não
            criam na vinda de um messias. Eles tentaram sufocar o evangelho ao
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="mt-0">
            Explanar sobre os primeiros acontecimentos que impulsionaram a
            missão mundial e exemplificar como 4 homens foram importantes para a
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            estava quase pronta para iniciar sua missão mundial. O Espírito
            Santo começará a dispersar os cristãos pelo mundo, mas primeiramente
            Lucas explana os fundamentos da missão contando a história de
            Estêvão, o mártir, Filipe, o evangelista, Saulo, o fariseu e a de
            Cornélio, o centurião. Juntamente com Pedro, esses quatro homens
            contribuíram fortemente para a propagação do Evangelho.
          </P>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            Quem era Estêvão? Precisamos fazer uma revisão da lição anterior
            para recordarmos quem ele era:
          </P>
          <P className="">
            <em>
              Naqueles dias, aumentando o número dos discípulos, houve
              ...
              reputação, cheios do Espírito e de sabedoria, para os
              encarregarmos desse serviço. Quanto a nós, nos consagraremos à
              oração e ao ministério da palavra. O parecer agradou a todos.
              Então elegeram Estêvão, homem cheio de fé e do Espírito Santo,
              Filipe, Prócoro, Nicanor, Timão, Pármenas e Nicolau, prosélito de
              Antioquia. Apresentaram estes homens aos apóstolos, que, orando,
          ...
          <P className="">
            ...
            apresentado como um homem cheio de graça e poder, que fazia
            prodígios e grandes sinais no meio do povo (Atos 6:8). Agora se diz
            que além dos apóstolos, outros discípulos também operavam prodígios
            e sinais, não se limitando somente aos 12.
          </P>
          <P className="">
            Outro fator importante sobre Estêvão é que, apesar de fazer parte
            dos 7 escolhidos para a área administrativa da igreja, ele não
            deixou de pregar, pois foi contra a sua palavra que alguns se
            levantaram. Eles eram da sinagoga chamada dos Libertos, dos
            cireneus, dos alexandrinos e dos da Cilícia e da província da Ásia.
            Os &quot;Libertos&quot; (<em>libertinoi</em>, uma transliteração
            grega de uma palavra latina) eram escravos libertos e seus
            descendentes. Por terem sido libertos da escravidão, eram judeus
            estrangeiros que teriam se mudado para Jerusalém. E os outros? Quem
            eram os judeus de Cirene, Alexandria, Cilícia e Ásia? Alguns
            estudiosos creem que seriam 4 sinagogas diferentes somadas à dos
            Libertos. Já outros julgam ser duas, três ou quatro sinagogas. John
            Stott considera ser somente uma, pois a palavra está no singular.
            Talvez Saulo de Tarso estivesse no meio dos judeus uma vez que ele
            era originário da Cilícia.
          </P>
          <P className="">
          ...
          <P className="">
            Posteriormente, esses judeus da sinagoga investiram contra Estêvão,
            o agarraram e o levaram ao sinédrio, apresentando testemunhas falsas
            ...
            lei a &quot;escritura sagrada&quot;, ou seja, Estêvão estaria
            falando contra Deus. Eles usaram o fato de este discípulo ter dito
            que Jesus, o Nazareno, destruiria este lugar e mudaria os costumes
            que Moisés havia dado. O Evangelho de João nos explica ao que Cristo
            estava se referindo:
          </P>
          <P className="">
            <em>
          ...
          <P className="">
            Jesus está falando de si mesmo ao falar da destruição do templo,
            pois haveria de ressuscitar após 3 dias. Logo, O Cristo falou de seu
            próprio corpo e afirma que Ele é o novo templo de Deus. Por isso
            que, embora no passado terem se reunido no templo para se
            encontrarem com Deus, o novo local para esse ajuntamento seria Ele
            mesmo. O segundo ponto, sobre Jesus falar contra a escritura
            sagrada, nos remete ao fato de que Ele disse que cumpriria a lei
            dando a sua vida por nós, consumando todo o sacerdócio e sacrifício.
            Portanto, o templo e a lei seriam substituídos. Os judeus
            simplesmente usaram o sentido literal das palavras do Nazareno.
          </P>
          <P className="">
          ...
          <P className="">
            ...
            apedrejamento pode ser considerado um linchamento popular. E
            deixaram suas vestes aos pés de um jovem chamado Saulo (v. 58b).
          </P>
          <P className="">
            ...
            que o apedrejaram. Bem parecido com as palavras de Jesus na cruz,
            com a diferença de que O Messias se dirigiu a Deus e Estêvão clamou
            a Jesus. O discípulo imitando o seu mestre. E adormeceu: um termo
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            Ao fugirem da perseguição contra a igreja, os discípulos iam por
            toda a parte pregando o Evangelho. Enquanto os apóstolos continuavam
            em Jerusalém, os outros cristãos conduziram a evangelização nos
            outros locais: &quot;
            <em>
              Entrementes, os que foram dispersos iam por toda parte pregando a
              palavra
            </em>
            &quot; (Atos 8:4). Porém, isso não significa dizer que viraram
            &quot;pregadores&quot; ou &quot;missionários&quot; de tempo
            integral, pois a expressão grega não significa mais do que
            &quot;compartilharam as boas novas&quot;.
          </P>
          <P className="">
            <em>
          ...
          <P className="">
            <em>
              ...
              caminho que desce de Jerusalém a Gaza; este se acha deserto.
              Filipe se levantou e foi. Havia um etíope, eunuco, alto oficial de
              Candace, rainha dos etíopes, o qual era superintendente de todo o
              seu tesouro. Ele tinha vindo adorar em Jerusalém e estava
              regressando ao seu país. E, assentado na sua carruagem, vinha
              lendo o profeta Isaías. (Atos 8:26-27)
            </em>
          </P>
          <P className="">
            A &quot;Etiópia&quot; a que Atos se refere correspondia ao
            &quot;Nilo Superior&quot; de hoje, área de Assuã a Cartum. O Etíope
            exercia um cargo alto e provavelmente era um negro africano. Ele
            pode ter sido judeu por nascimento ou conversão, uma vez que a
            dispersão judaica tinha chegado ao Egito e, talvez, além dessa
            região. Não é provável que ele seja gentio, pois Lucas o teria
            apontado como o primeiro gentio convertido.
          </P>
          <P className="">
            ...
            verdade. Ele acreditava que cada pessoa deveria ser incentivada a
            ler e interpretar a Bíblia, não apenas de maneira passiva, mas de
            forma ativa, participando do processo de compreensão e aplicação dos
            ensinamentos bíblicos. Para ele, o estudo bíblico era essencial para
            uma fé genuína e uma vida cristã sólida, destacando que a
            negligência desse estudo afastava os cristãos da verdadeira
            compreensão de Deus e de Sua vontade. O coração do eunuco estava com
            solo fértil para receber o evangelho e foi prontamente batizado.
            Paulo precisou de uma visão sobrenatural de Jesus para crer,
            enquanto o etíope não passou por absolutamente nada que fosse
            sobrenatural, mas creu.
          </P>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            <em>
              ...
              sinagogas de Damasco, a fim de que, caso achasse alguns que eram
              do Caminho, tanto homens como mulheres, os levassem presos para
              ...
              vendo ninguém. Então Saulo se levantou do chão e, abrindo os
              olhos, nada podia ver. E, guiando-o pela mão, levaram-no para
              Damasco. Esteve três dias sem ver, durante os quais nada comeu,
              nem bebeu. (Atos 9:1-9)
            </em>
          </P>
          <P className="">
          ...
          <P className="">
            ...
            instrumento poderoso na evangelização dos gentios e Jesus fez
            questão de confirmar seu ministério através de outro discípulo.
          </P>
          <P className="">
            <em>
          ...
          <P className="">
            ...
            como parte da família cristã. Interessante notar que Ananias impôs
            as mãos em um homem temporariamente cego. Um toque para uma pessoa
            que não podia ver a expressão no rosto de Ananias, mas conseguia
            sentir seu toque de cuidado. Saulo se torna agora o propagador das
          ...
          <P className="">
            ...
            cerimonialmente impuros por trabalharem com animais mortos. Como
            Deus iria lidar com Pedro e mudar a intolerância racial dele? A
            resposta é dada nesta visão:
          </P>
          <P className="">
            <em>
              ...
              vezes, e, em seguida, aquele objeto foi levado de volta para o
              céu. (Atos 10:9-16)
            </em>
          </P>
          <P className="">
            ...
            entender primeiramente que a salvação é estendida a todas as
            pessoas. Pedro e os que foram com ele à casa de Cornélio testificam
            que o Espírito Santo é derramado sobre os gentios também (Atos
            10:44-46). Os da casa de Cornélio pedem a Pedro que permanecesse com
            eles por alguns dias, pois seria uma forma de nutri-los com a
            palavra. Portanto, concluímos que o Espírito Santo faz a obra de
            conversão, mas também precisamos de mestres humanos para nos ensinar
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            para que os gentios sejam alcançados. Mesmo estando prestes a
            morrer, Estêvão prega as &quot;boas novas&quot;. O primeiro mártir
            dá o exemplo de como importa sofrermos por Cristo para que o
            Evangelho seja propagado. Filipe, com sua ousadia, estende a
            mensagem cristã aos samaritanos, quebrando a barreira de anos de
            desentendimento com os judeus.
          </P>
          <P className="">
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            (provavelmente o primeiro gentio a se converter) a igreja entende
            que a salvação é para todos os que creem. Entretanto, o evangelismo
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            separar Barnabé e Saulo para a obra que os tinha chamado. Barnabé
            era um homem de bem, cheio do espírito e de muita fé (Atos 11:24).
          </P>
          <P className="">
            ...
            médicos, oficiais do exército, sacerdotes e políticos, não
            explicando se a ajuda de Marcos era no sentido pastoral ou prática
            (cozinhando, limpando). Lucas enfatiza três episódios na primeira
            viagem missionária: Paulo compartilhando as &quot;boas novas&quot;
            para o procônsul e confrontando um judeu mágico em Pafos, pregando
            em Antioquia da Pisídia e falando ao ar livre para pagãos em Listra.
          </P>
          <P className="">
          ...
          <P className="">
            ...
            <em>
              Mas Paulo não achava justo levar aquele que tinha se afastado
              deles desde a Panfília, não os acompanhando no trabalho.
            </em>{" "}
            O termo &quot;afastar&quot; tem o significado de
            &quot;desertar&quot;, &quot;abandonar&quot;. Entretanto,
            posteriormente, João voltou a ser útil para o ministério de Paulo
          ...
          <P className="">
            Através da Lei de Moisés não há justificação para ninguém, porém,
            por intermédio de Jesus todo o que crê será salvo. A resposta à
            pregação de Paulo foi positiva:
          </P>
          <P className="">
            <em>
              &quot;Quando Paulo e Barnabé estavam saindo, as pessoas pediram
              que, no sábado seguinte, lhes falassem estas mesmas palavras.
              Terminada a reunião na sinagoga, muitos dos judeus e dos
              prosélitos piedosos seguiram Paulo e Barnabé, e estes, falando com
              eles, os persuadiam a continuar firmes na graça de Deus&quot;.
              (Atos 13:42-43)
            </em>
          </P>
          <P className="">
            ...
            Paulo responderam:{" "}
            <em>
              Era necessário pregar a palavra de Deus primeiro a vocês. Mas,
              como vocês a rejeitam e se julgam indignos da vida eterna, eis que
              nós voltamos para os gentios
            </em>{" "}
            ...
            Lá, pregaram de tal forma que muitos vieram a crer, tanto judeus
            como gregos. Apesar de os judeus que não creram neles terem incitado
            e irritado o ânimo dos gentios, Paulo e Barnabé ainda passaram um
            bom tempo evangelizando em Icônio. Todavia, alguns judeus e gentios
          ...
          <P className="">
            <em>
              ...
              templo estava em frente da cidade, trazendo touros e grinaldas
              para junto dos portões da cidade, queria oferecer um sacrifício
              ...
              sentimentos, e anunciamos o evangelho a vocês para que se
              convertam destas coisas vãs ao Deus vivo, que fez o céu, a terra,
          ...
          <P className="">
            ...
            procurar abrigo, foram rejeitados milhares de vezes, até que um
            casal de camponeses idosos ofereceram sua cabana para hospedá-los,
            embora fossem pobres. Os deuses recompensaram os idosos, mas
            destruíram os que não os ajudaram com uma enchente. Como a língua
            licaônica era usada para anunciar a sua crença de que os deuses os
            visitavam, Paulo e Barnabé não compreendiam o que estava acontecendo
            inicialmente. O fato de os missionários terem rasgado as suas vestes
            reflete quão horrorizados estavam com a blasfêmia do povo.
          </P>
          <P className="">
            <em>
              — Senhores, por que estão fazendo isto? Nós também somos seres
              humanos como vocês, sujeitos aos mesmos sentimentos, e anunciamos
              o evangelho a vocês para que se convertam destas coisas vãs ao
              Deus vivo, que fez o céu, a terra, o mar e tudo o que neles há.
              Nas gerações passadas, Deus permitiu que todos os povos andassem
              nos seus próprios caminhos. Contudo, não deixou de dar testemunho
              de si mesmo, fazendo o bem, dando a vocês chuvas do céu e estações
              frutíferas, enchendo o coração de vocês de fartura e de alegria.
              Dizendo isto, foi ainda com dificuldade que impediram a multidão
              de lhes oferecer sacrifícios. (Atos 15:15-18)
            </em>
          </P>
          <P className="">
            O discurso de Paulo para iletrados pagãos nos mostra como o apóstolo
            usava abordagens diferentes para falar com leigos em Listra. Ao
            falar com os judeus em Antioquia, ele prega sobre o Antigo
            Testamento, mas com os pagãos, ele usou o mundo natural ao redor,
            que eles conheciam e viam. A mensagem tem seu cerne em Cristo, mas
            com abordagens diferentes para grupos de pessoas distintas. Após ser
            apedrejado e ir a Derbe, Paulo retorna com Barnabé a Listra, Icônio
            e Antioquia da Síria. Precisamos dar ênfase ao versículo de Atos
            14:23:{" "}
            <em>
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            <em>
              ...
              discussão de Paulo e Barnabé com eles, foi resolvido que esses
              dois e mais alguns fossem a Jerusalém, aos apóstolos e
              presbíteros, para tratar desta questão. (Atos 15:1-2)
            </em>
          </P>
          <P className="">
          ...
          <P className="">
            O concílio de Jerusalém obteve duas conquistas: confirmou o
            Evangelho da graça e o amor venceu ao preservar a comunhão através
            de concessões aos escrúpulos dos judeus conscienciosos. Como Lutero
            afirma: Paulo era forte na fé e manso no amor.
          </P>
        </div>

        <div className="flex flex-col gap-4">
          <H3 id="lesson-4-missoes">Tópico 3: Missões (Atos 16:6-21:17)</H3>
          <P className="">
            ...
            incluía as capitais em suas viagens e ainda escreveria a cada uma
            das igrejas nessas capitais.
          </P>
          <P className="">
            <em>
              ...
              noite, Paulo teve uma visão na qual um homem da Macedônia estava
              em pé e lhe rogava, dizendo: — Passe à Macedônia e ajude-nos.
              Assim que Paulo teve a visão, imediatamente procuramos partir para
              aquele destino, concluindo que Deus nos havia chamado para lhes
              anunciar o evangelho. (Atos 16:6-10)
            </em>
          </P>
          <P className="">
            Uma característica importante nas viagens de Paulo é que ele estava
            na total dependência do Espírito Santo. O Espírito o impede de
            pregar na província da Ásia, de ir para Bitínia e é o mesmo quem lhe
            deu uma visão para ir à Macedônia. Outro fator essencial é a
            prontidão de Paulo para obedecer ao chamado de Deus, pois no
            versículo 10 eles procuraram partir <em>imediatamente</em>.
            Entretanto, o apóstolo não tomou uma decisão sozinho, pois o verbo
            &quot;concluindo&quot;, significa literalmente &quot;juntar&quot;,
            &quot;encaixar mentalmente&quot;. Ou seja, ele partilhou os dados
            com os outros para, assim, decidir partir.
          </P>
          <P className="">
            Lucas cita a conversão de 3 pessoas em Atos 16: Lídia, a qual parece
            ser uma mulher rica, uma jovem escrava anônima e o carcereiro
            romano. Pessoas de diferentes classes sociais, mas que foram
            recebidas sem distinção na igreja. No judaísmo, o cabeça da casa
            sempre orava agradecendo não ter nascido mulher, gentio nem escravo,
            mas aqui estavam os representantes dessas classes salvos em Cristo.
          </P>
          <P className="">
            Como Paulo havia escrito aos gálatas: não pode haver judeu nem
            grego; nem escravo nem liberto; nem homem nem mulher; porque todos
            vós sois um em Cristo. Este é o poder unificador do Evangelho.
          </P>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            Depois de suas viagens missionárias, Paulo chega a Jerusalém e há
            uma mudança abrupta. Ele foi atacado, capturado, preso e julgado.
            Lucas relata os 5 julgamentos que ele passou: diante de uma multidão
            de judeus na área do templo, diante do Supremo Conselho dos judeus,
            em Cesareia (terceiro e quarto) diante de Félix e Festo e o último
          ...
          <P className="">
            ...
            redentora, eles foram parecidos com o de Jesus, pois ambos o
            apóstolo e o Messias: foram rejeitados pelo seu próprio povo, foram
            acusados injustamente, foram batidos no rosto diante de um tribunal,
            foram vítimas infelizes dos planos dos judeus, ouviram o barulho de
            uma multidão que dizia &quot;mata-o&quot; e foram sujeitados a uma
            série de 5 julgamentos.
          </P>
          <P className="">
          ...
          <P className="">
            Coragem! Coragem, Paulo! Provavelmente, a violência dos últimos
            dias, a acusação dos judeus e estar diante do sinédrio deixaram o
            apóstolo ansioso quanto ao que estava por vir. Jesus o conforta com
            uma palavra clara e direta, o que deve ter dado a ele a calma e
            coragem que ele precisava para suportar os 3 primeiros julgamentos,
            2 anos de prisão e sua viagem cheia de adversidades até Roma.
          </P>
          <P className="">
            Roma era a capital do Império Romano e sua fundação foi chamada de
            &quot;a maior conquista política de todos os tempos&quot;. Era a
            maior e mais estonteante das cidades antigas, ficando famosa pela
            sua administração e facilitou viagens através de um sistema de
            estradas e portos, agindo como ímã para as pessoas. Era ali que
            poderia ser o centro de propagação do Evangelho. Paulo chegou a Roma
            apesar de uma viagem atribulada, mas chegou como prisioneiro. A
            promessa de Jesus não incluiu esta informação. Sua prisão e
            julgamento deram-se por sua lealdade ao Evangelho. O sofrimento
            autenticou o seu ministério e ele estava à disposição de morrer por
            Cristo. Ele combateu o bom combate, completou a carreira, guardou a
            fé.
          </P>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            cumprida de pregar as boas novas &quot;até os confins da
            terra&quot;. Vemos como as igrejas foram instituídas pelo Espírito
            Santo e como o apóstolo precisava se afastar para que elas ficassem
            dependentes de Deus.
          </P>
          <P className="">
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-4">
          <P className="">
            ARMÍNIO, Jacó.{" "}
            <em>
              The Works of James Arminius, D.D., Formerly Professor of Divinity
              in the University of Leyden.
            </em>{" "}
            Translated by James Nichols, Auburn and Buffalo: Derby, Miller and
            Orton, 1853.
          </P>
          <P className="">
