  ...
  return (
    <section className="relative backdrop-blur-sm">
      ...
      <HeroContainer className="pb-2 sm:pb-0">
        ...
        <HeroImage
          src="/images/oceano-academy/materiais-didaticos/panorama-biblico-at/panorama-biblico-at-cover.webp"
          alt="Panorama Bíblico do Antigo Testamento"
        />
      </HeroContainer>
            ...
            <TableRow className="hover:bg-transparent">
              ...
              <TableCell>
                <TableCellLinksContainer>
                  ...
                  <LinkSmall href="https://drive.google.com/file/d/1nQ39SuD5wfy6aDXu6iD4QU_-8wDmCxDv/view?usp=sharing">
                    <Wallpaper className="size-4" />
                    L7: Divisão
                  </LinkSmall>
                  <LinkSmall href="https://drive.google.com/file/d/15mmU7HxlR3Y2MJbWSAmjJJhfinNifCyI/view?usp=sharing">
                    <Wallpaper className="size-4" />
                    L8: Recomeço
                  </LinkSmall>
                </TableCellLinksContainer>
