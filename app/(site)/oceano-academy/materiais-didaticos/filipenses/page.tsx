...
export const metadata = {
  alternates: {
    types: {
      "text/markdown": "/oceano-academy/materiais-didaticos/filipenses.md",
    },
  },
};
  ...
  return (
    <section className="relative backdrop-blur-sm">
      ...
      <HeroContainer className="pb-2 sm:pb-0">
        ...
        <HeroImage
          src="/images/oceano-academy/materiais-didaticos/filipenses/filipenses-cover.webp"
          alt="Carta aos Filipenses"
        />
      </HeroContainer>
        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent">
              ...
              <TableCell>
                <TableCellLinksContainer>
                  ...
                  <LinkSmall href="/oceano-academy/materiais-didaticos/filipenses.md">
            ...
            <TableRow className="hover:bg-transparent">
              ...
              <TableCell>
                <TableCellLinksContainer>
                  <LinkSmall href="https://drive.google.com/file/d/1Buwz0bieUJMdDWK4FdbPqt7xOP3GTbAh/view?usp=sharing">
                    <FileText className="size-4" />
                    Plano de Estudo
                  </LinkSmall>
                </TableCellLinksContainer>
