...
export const metadata = {
  alternates: {
    types: {
      "text/markdown": "/oceano-academy/materiais-didaticos/colossenses.md",
    },
  },
};
    ...
    <section className="relative backdrop-blur-sm">
      ...
      <HeroContainer className="pb-2 sm:pb-0">
        <div className="flex flex-col gap-2">
          <H1 className="text-left">Carta aos Colossenses</H1>
          <P className="mt-0">
            Compreendendo a supremacia e suficiência de Cristo por meio da carta
            do apóstolo Paulo aos Colossenses.
          </P>
        </div>

        <HeroImage
          src="/images/oceano-academy/materiais-didaticos/colossenses/colossenses-cover.webp"
          alt="Carta aos Colossenses"
        />
      </HeroContainer>
        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent">
              ...
              <TableCell>
                <TableCellLinksContainer>
                  ...
                  <LinkSmall href="/oceano-academy/materiais-didaticos/colossenses.md">
            ...
            <TableRow className="hover:bg-transparent">
              ...
              <TableCell>
                <TableCellLinksContainer>
                  <LinkSmall href="https://drive.google.com/file/d/1BQjWaU1wQTmUe3qKNFUMK_wP4X5zBwcJ/view?usp=sharing">
                    <FileText className="size-4" />
                    Plano de Estudo
                  </LinkSmall>
                </TableCellLinksContainer>
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <UL className="mt-0 space-y-2 sm:space-y-2">
          ...
          <SummaryLi subList>
            <a href="#lesson-1-cristo-a-imagem-do-deus-invisivel">
              1. Cristo, a Imagem do Deus Invisível
            </a>
          </SummaryLi>
          <SummaryLi subList>
            <a href="#lesson-1-o-criador-e-sustentador-de-todas-as-coisas">
              2. O Criador e Sustentador de Todas as Coisas
            </a>
          </SummaryLi>
          <SummaryLi subList>
            <a href="#lesson-1-a-plenitude-da-divindade-em-cristo">
              3. A Plenitude da Divindade em Cristo
            </a>
          </SummaryLi>
          <SummaryLi subList>
            <a href="#lesson-1-a-reconciliacao-da-humanidade-pelo-seu-sangue">
          ...
          <SummaryLi subList>
            <a href="#lesson-2-conhecendo-a-vontade-de-deus">
              1. Conhecendo a Vontade de Deus
            </a>
          </SummaryLi>
          <SummaryLi subList>
            <a href="#lesson-2-frutificando-em-toda-boa-obra">
              2. Frutificando em Toda Boa Obra
            </a>
          </SummaryLi>
          <SummaryLi subList>
            <a href="#lesson-2-fortalecidos-pelo-poder-de-deus">
              3. Fortalecidos Pelo Poder de Deus
            </a>
          </SummaryLi>
          <SummaryLi subList>
            <a href="#lesson-2-a-redencao-e-o-perdao-em-cristo">
          ...
          <SummaryLi subList>
            <a href="#lesson-3-firmados-e-edificados-em-cristo">
              1. Firmados e Edificados em Cristo
            </a>
          </SummaryLi>
          <SummaryLi subList>
            <a href="#lesson-3-o-perigo-das-doutrinas-humanas">
              2. O Perigo das Doutrinas Humanas
            </a>
          </SummaryLi>
          <SummaryLi subList>
            <a href="#lesson-3-a-plenitude-da-vida-em-cristo">
              3. A Plenitude da Vida em Cristo
            </a>
          </SummaryLi>
          <SummaryLi subList>
            <a href="#lesson-3-a-autoridade-suprema-de-cristo">
          ...
          <SummaryLi subList>
            <a href="#lesson-4-buscando-as-coisas-do-alto">
              1. Buscando as Coisas do Alto
            </a>
          </SummaryLi>
          <SummaryLi subList>
            <a href="#lesson-4-despojando-se-do-velho-homem">
              2. Despojando-se do Velho Homem
            </a>
          </SummaryLi>
          <SummaryLi subList>
            <a href="#lesson-4-revestindo-se-do-novo-homem">
              3. Revestindo-se do Novo Homem
            </a>
          </SummaryLi>
          <SummaryLi subList>
            <a href="#lesson-4-vivendo-em-amor-e-harmonia-crista">
          ...
          <SummaryLi subList>
            <a href="#lesson-5-a-perseveranca-na-oracao">
              3. A Perseverança na Oração
            </a>
          </SummaryLi>
          <SummaryLi subList>
            <a href="#lesson-5-o-testemunho-externo-e-a-palavra-temperada">
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            Posteriormente, Paulo o enviou de volta a cidade de Colossos, na
            companhia de Tíquico (Col 4.7-9), com duas cartas: uma para seu
            senhor Filemon e outra para a Igreja de Colossos.
          </P>
          <P className="">
          ...
          <P className="">
            ...
            contexto da Igreja de Colossos, bem como os falsos mestres que
            distorciam os ensinamentos da divindade e a preeminência de Cristo.
          </P>
          <P className="">
            A heresia em meio a Igreja de Colossos do Segundo Século apareceu em
            um movimento conhecido como Gnosticismo. Alguns dos seus princípios
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-1-cristo-a-imagem-do-deus-invisivel">
            1. Cristo, a Imagem do Deus Invisível
          </H3>
          <P className="">
          ...
          <P className="">
            ...
            presente, descrevendo a posição de Jesus agora e para sempre (Jo
            10.30,38; 12.45; 14.1-11). Deus, como Espírito, é invisível e sempre
            será (1 Tm 6.16). O Filho de Deus é a sua expressão visível. Ele não
            só reflete a Deus, mas, como Deus, Ele revela Deus a nós (Jo 1.18;
            14.9; Hb 1.1,2).
          </P>
          <P className="">
          ...
          <P className="">
            ...
            resposta do apóstolo aos gnósticos. Ao contrário do que eles
            ensinavam, Jesus não é uma pessoa criada por Deus, mas Ele é Deus,
            sendo feita a distinção eterna na substância de Deus. No Novo
            Testamento, encontramos diversas referências que demonstram essa
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-1-o-criador-e-sustentador-de-todas-as-coisas">
            2. O Criador e Sustentador de Todas as Coisas
          </H3>
          <P className="">
            Paulo fala da Supremacia e centralidade de Cristo em relação à
            criação, e mostra para Colossos que Cristo é antes de todas as
            coisas. Ele não é só o Criador do mundo, Ele também é o seu
            Sustentador. Por Ele, todas as coisas vieram a existir, e por Ele,
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-1-a-plenitude-da-divindade-em-cristo">
            3. A Plenitude da Divindade em Cristo
          </H3>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-1-a-reconciliacao-da-humanidade-pelo-seu-sangue">
            4. A Reconciliação da Humanidade Pelo Seu Sangue
          </H3>
          <P className="">
            ...
            legalistas e absurda para os filósofos da época, revela-se como o
            poder de Deus para a salvação. Aquilo que parecia loucura aos olhos
            humanos é, na verdade, o caminho divinamente estabelecido para a
            reconciliação e a redenção dos que creem. (1 Co 1.18).
          </P>
          <P className="">
          ...
          <P className="">
            ...
            poderiam de alguma forma aproximar os homens a Deus. Em
            contrapartida, Paulo diz que, Jesus Cristo é o único meio de
            reconciliação e sua morte na cruz, o único método que Deus escolheu
            para usar. (Atos 4.12). O Pai que soberanamente, quis reconciliar
            todas as coisas através do Filho.
          </P>
          <P className="">
            O que podemos entender é que somente na cruz, nosso Senhor Jesus
            colocou o fundamento da reconciliação da humanidade pelo seu sangue.
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            profundidade a centralidade absoluta de Cristo no Evangelho da
            salvação. Ele não é apenas parte da mensagem. Ele é o próprio
            conteúdo do Evangelho. Cristo é suficiente, completo, pleno. Nele
            encontramos tudo o que precisamos para a salvação e para uma vida
            abundante, conforme o plano de Deus.
          </P>
          <P className="">
            Infelizmente, muitos têm buscado alternativas que substituam a fé
            genuína por modismos revestidos de uma aparência cristã. Práticas
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            A igreja de Colossos não foi estabelecida diretamente por Paulo,
            contudo, isso não o impediu de dirigir-se a ela por meio de sua
            epístola, tampouco de interceder com frequência por seus membros.
            Ainda que não os conhecesse pessoalmente, o apóstolo demonstrava
            preocupação e constante oração em favor daqueles irmãos. Nos
            versículos introdutórios da carta, evidencia-se seu profundo
            comprometimento com a expansão do Evangelho, ao priorizar a obra de
            Deus realizada naquele contexto, mesmo diante de suas próprias
            limitações e necessidades pessoais.
          </P>
          <P className="">
          ...
          <P className="">
            ...
            herança dos santos na luz, concedendo-lhes a esperança da glória
            futura, firmada em Cristo e não nos méritos humanos. Em seguida,
            reforça que foi Cristo quem os libertou do domínio das trevas e os
            trasladou para o reino do Filho do Seu amor. Essa declaração carrega
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-2-conhecendo-a-vontade-de-deus">
            1. Conhecendo a Vontade de Deus
          </H3>
          <P className="">
            Após a saudação inicial e a identificação como autor da epístola,
            Paulo dirige-se aos colossenses expressando gratidão a Deus por suas
            vidas, fundamentado nas informações recebidas de Epafras. O apóstolo
            destaca sua prática contínua de oração em favor da comunidade cristã
            de Colossos. No versículo 9, Paulo enfatiza novamente sua
            persistência em interceder por eles, evidenciando não apenas seu
            profundo afeto pela igreja, mas também sua intenção de que os
            colossenses alcancem o pleno conhecimento da vontade de Deus. Essa
            intercessão tem como objetivo promover o crescimento espiritual e a
            conformidade prática da igreja com os propósitos de Deus.
          </P>
          <P className="">
            Paulo manifesta seu profundo amor pela igreja ao dedicar-se
            incansavelmente à intercessão por ela, mesmo estando preso e prestes
            a ser entregue à morte. Em vez de pedir por sua própria libertação,
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-2-frutificando-em-toda-boa-obra">
            2. Frutificando em Toda Boa Obra
          </H3>
          <P className="">
          ...
          <P className="">
            ...
            Colossos demonstrassem, por meio de suas obras, uma conduta
            condizente com sua nova identidade em Cristo.
          </P>
          <P className="">
            Nesse sentido, o apóstolo Tiago complementa o pensamento paulino ao
            destacar que fé e obras são dimensões inseparáveis da vida cristã,
            sendo as obras evidência concreta da fé genuína (Tg 2.18). Elas
            tornam visível o que, por natureza, é invisível, confirmando a
            transformação operada em quem crê. O próprio apóstolo Paulo afirma
            que o cristão passa por uma mudança radical de identidade, marcada
            pela ruptura com o pecado e pela vivência de uma nova realidade em
            Cristo (2Co 5.17). É precisamente essa fé prática e transformadora
            que ele busca incentivar entre os colossenses.
          </P>
        </div>

        <div className="flex flex-col gap-4">
          <H3 id="lesson-2-fortalecidos-pelo-poder-de-deus">
            3. Fortalecidos Pelo Poder de Deus
          </H3>
          <P className="">
            Muitas vezes temos clara consciência da conduta que deveríamos
            adotar, mas a temos dificuldade em colocá-la em prática. Essa tensão
            entre o saber e o agir é igualmente evidenciada por Paulo (Rm 7.19).
          ...
          <P className="">
            O apóstolo Paulo, em Efésios 6.10, exorta os crentes a se
            fortalecerem no Senhor e no poder dEle. Em seguida, apresenta a
            armadura espiritual como recurso indispensável contra as estratégias
            do inimigo. Seu objetivo é mostrar que a confiança não deve estar na
            força humana, mas na dependência contínua de Deus, por meio da
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-2-a-redencao-e-o-perdao-em-cristo">
            4. A Redenção e o Perdão em Cristo
          </H3>
          <P className="">
          ...
          <P className="">
            ...
            resgatou o ser humano do domínio das trevas, não para deixá-lo à
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            que vinha mantendo tanto pelos colossenses como pelos laodicenses, o
            que descreve a vida de oração que ele, assim como os demais
            apóstolos, precisava manter por seus filhos na fé, para que o Senhor
            os livrasse de todo conhecimento enganoso (v. 4).
          </P>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-3-firmados-e-edificados-em-cristo">
            1. Firmados e Edificados em Cristo
          </H3>
          <P className="">
          ...
          <P className="">
            ...
            construídos e firmados sobre o mesmo fundamento — Cristo — e a
          ...
          <P className="">
            ...
            uma árvore que, quanto mais cresce e produz frutos, é aprovada, da
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-3-o-perigo-das-doutrinas-humanas">
            2. O Perigo das Doutrinas Humanas
          </H3>
          <P className="">
          ...
          <P className="">
            ...
            Portanto, os crentes deveriam ser firmes na escolha e permanência no
            caminho certo todos os dias, considerando isso em todas as suas
            decisões. Seu fundamento não eliminava as tentações provenientes de
            outros caminhos.
          </P>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-3-a-plenitude-da-vida-em-cristo">
            3. A Plenitude da Vida em Cristo
          </H3>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-3-a-autoridade-suprema-de-cristo">
            4. A Autoridade Suprema de Cristo
          </H3>
          <P className="">
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="mt-0">
            ...
            caráter de Jesus, vivendo em comunhão, amor e santidade.
          </P>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            Paulo, depois de enfatizar a soberania de Cristo, a maneira de viver
            do cristão no primeiro capítulo, e o perigo de se deixar enganar por
            vãs filosofias no segundo capítulo, toma agora uma abordagem mais
            prática e incisiva sobre como devem proceder aqueles que são novas
          ...
          <P className="">
            ...
            Palavra de Deus, não apenas no conhecimento, mas na prática diária
            dos princípios bíblicos (Tg 1.22), ocupando a mente com aquilo que
            edifica a fé e fortalece a esperança em Cristo.
          </P>
          <P className="">
            Por fim, Paulo lembra que tudo o que o cristão fizer, seja em
            palavras ou ações, deve ser feito em nome do Senhor Jesus, dando
            graças a Deus Pai (Cl 3.17).
          </P>
        </div>

        <div className="flex flex-col gap-4">
          <H3 id="lesson-4-buscando-as-coisas-do-alto">
            1. Buscando as Coisas do Alto
          </H3>
          <P className="">
          ...
          <P className="">
            ...
            voláteis deste mundo, mas aquelas da nossa verdadeira pátria: o céu.
            Não digo que devemos deixar de ambicionar conquistas materiais por
            meios lícitos, mas nelas não deve estar o nosso coração (Mt 6.21). O
            sistema mundano e as suas paixões não devem mais ambicionar os olhos
            do salvo, pois para isso já morremos. Devemos nos alegrar em Cristo
            Jesus nas bênçãos que nos estão disponíveis mediante Sua vitória
            sobre a morte (Ef 1.3).
          </P>
          <P className="">
            Quando Paulo escreveu aos Filipenses, no capítulo 3, ele fala de
            coisas que para muitos são o que de fato importa, que é: status,
            títulos, fama etc. Ele, porém, a partir do versículo 8, deixa claro
            que, depois que conheceu a Cristo e foi atingido por Seu amor, todas
            as coisas da terra perderam o brilho. O amor de Jesus pelo pecador
            ofusca a beleza das coisas passageiras (Fp 3.1-14).
          </P>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-4-despojando-se-do-velho-homem">
            2. Despojando-se do Velho Homem
          </H3>
          <P className="">
            Agora, limpos e despojados do pecado pelo sangue de Jesus Cristo e
            revestidos de roupas novas e santas, não podemos mais andar vestidos
            com as roupas antigas e sujas. Para isso, é necessário mortificar a
            velha natureza. Paulo compara as obras da carne a vestes velhas e
            sujas, que devem ser descartadas e substituídas por roupas novas e
            limpas. Essa nova veste só é possível mediante a obra redentora de
            Jesus Cristo.
          </P>
          <P className="">
          ...
          <P className="">
            ...
            tentações carnais, nem dos investimentos de Satanás para atrapalhar
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-4-revestindo-se-do-novo-homem">
            3. Revestindo-se do Novo Homem
          </H3>
          <P className="">
            O novo homem não tem nenhuma semelhança com o antigo; o antigo só
            praticava e vivia no pecado e nas suas impurezas. O novo homem é
            nascido da água e do Espírito (Jo 3.3-6).
          </P>
          <P className="">
          ...
          <P className="">
            ...
            fruto do Espírito e não pelas obras da carne. Isso não deve ser uma
            utopia, mas uma realidade. Se alguém estiver andando diferente desse
            padrão, deve voltar às raízes do cristianismo e não ser uma prótese
            no corpo. O padrão de Deus para a vida do salvo não é aquele que
            ocorria com os coríntios em 1Co 1.10-13, mas o de At 2.42-44.
          </P>
        </div>

        <div className="flex flex-col gap-4">
          <H3 id="lesson-4-vivendo-em-amor-e-harmonia-crista">
            4. Vivendo em Amor e Harmonia Cristã
          </H3>
          <P className="">
            Paulo orienta os crentes de Colossos que o chamado de Deus para o
            salvo é viver completamente na contramão do sistema mundano e
            retornar ao estado original planejado pelo Senhor: uma vida santa,
            harmoniosa e cheia do amor que provém d&apos;Ele.
          </P>
          <P className="">
            O ser humano passou tanto tempo sendo moldado pelos padrões do mundo
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            essência, da rotina sem paixão, da fé sem obras. Precisamos voltar à
            simplicidade e à profundidade da Palavra, ao fervor da oração, ao
            amor pelos perdidos e à comunhão sincera com os irmãos. O tempo é
            urgente, e o mundo clama por uma Igreja viva, santa e relevante, que
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="mt-0">
            ...
            amor, o respeito e a união devem ser multiplicados e,
            posteriormente, refletidos para fora, tendo um bom testemunho e
            refletindo o brilho do Espírito Santo na vida.
          </P>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            coração puro e não por obrigação ou para gloriar-se; tudo deve ser
            para a glória do Senhor, pois é dele que virá a devida recompensa.
          </P>
          <P className="">
            Não devemos ser um religioso que cumpre apenas as obrigações na
            igreja, tais como ir aos cultos com regularidade ou quando está
            escalado em alguma atividade, mas sim ser praticante da Palavra de
            Deus (Tg 1.19–27).
          </P>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            ...
            vitoriosa. O apóstolo Paulo também enfatiza essa verdade em suas
            cartas à igreja de Éfeso e a Timóteo.
          </P>
          <P className="">
            Nesse contexto, aprendemos que, quando há uma família feliz e bem
            estruturada no Senhor, são significativamente ampliadas as
            possibilidades de termos uma igreja igualmente sólida e abençoada.
          </P>
          <P className="">
            As famílias precisam, cada vez mais, investir em conexões
            presenciais, e não apenas virtuais. O que se observa atualmente é
            que, ainda que todos estejam sob o mesmo teto, na mesma sala ou à
            mesma mesa, cada qual se encontra imerso em seu próprio mundo
            digital, com os olhos fixos no smartphone.
          </P>
          <P className="">
            Com o avanço da tecnologia, vieram as redes sociais e os jogos
            online, que, na maioria das vezes, têm causado efeitos nocivos aos
            lares — inclusive os cristãos —, contribuindo para o enfraquecimento
            dos vínculos familiares. Esse distanciamento, vale lembrar, não teve
            início com os celulares, mas já se delineava no século passado, com
            os televisores ligados incessantemente, o que levou algumas
            denominações, inclusive, a proibirem seus membros de possuírem
            televisão em casa. Já imaginou seu pastor lhe proibindo de ter um
            smartphone?
          </P>
          <P className="">
          ...
          <P className="">
            ...
            esposa, respeito e submissão; ao marido, amor e dedicação. Ambos,
            porém, devem espelhar o amor de Cristo, servindo de exemplo de
            convivência para os filhos.
          </P>
          <P className="">
            Quanto ao relacionamento com os filhos, Paulo recomenda que os pais
            não os provoquem à ira. Sua exortação não diz respeito à ausência de
            disciplina, mas sim à maneira como esta é aplicada — evitando-se
            palavras ofensivas, humilhantes ou destrutivas. Pais, lembrem-se: os
            filhos são herança do Senhor (Sl 127.3) e devem ser corrigidos com
          ...
          <P className="">
            ...
            mas a Palavra de Deus permanece imutável. O mandamento de obediência
            aos pais subsiste mesmo após a maioridade, sendo dever dos filhos
            honrar e respeitar os pais ao longo de toda a vida, o que traz
            consigo a promessa de longevidade sobre a terra.
          </P>
        </div>

        <div className="flex flex-col gap-4">
          <H3 id="lesson-5-o-trabalho-como-servico-ao-senhor">
            2. O Trabalho Como Serviço ao Senhor
          </H3>
          <P className="">
          ...
          <P className="">
            ...
            forma direta contra a escravidão como instituição, mas condena, de
            forma veemente, os abusos e a violência extrema que muitos senhores
            praticavam contra seus servos, especialmente os insubmissos ou
            fugitivos.
          </P>
          <P className="">
            Hoje, essa relação pode ser comparada à relação existente entre
            empregados e patrões. Paulo exorta o servo a executar seu trabalho
          ...
          <P className="">
            ...
            servos (funcionários) com justiça e equidade, conscientes de que o
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-5-a-perseveranca-na-oracao">
            3. A Perseverança na Oração
          </H3>
          <P className="">
          ...
          <P className="">
            ...
            por mais impossível que pareça, algo extraordinário vai acontecer.
            Infelizmente, para alguns, a oração é vista como último recurso,
            quando, na verdade, deveria ser o primeiro passo diante de qualquer
            circunstância.
          </P>
          <P className="">
            A oração não muda Deus, pois ELE é imutável, e o que ELE determinou
            realmente vai acontecer. A oração, porém, transforma o coração do
            homem, ajusta sua perspectiva, modifica atitudes, alinha pensamentos
            e, sobretudo, fortalece a fé, aproximando-o ainda mais do Senhor.
          </P>
          <P className="">
            Jesus orava constantemente e ensinava aos discípulos sobre o poder
            da oração. Paulo, por sua vez, em suas cartas, fala sobre a
            necessidade de o crente orar em todo o tempo (1 Ts 5:17), com fé e a
            certeza de que está sendo ouvido pelo Senhor. Neemias, por exemplo,
            ao ser instado pelo rei Artaxerxes a responder, fez uma breve oração
            (Ne 2.4) pedindo a Deus sabedoria quanto ao que deveria dizer — e
            sua resposta foi acolhida favoravelmente.
          </P>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          <H3 id="lesson-5-o-testemunho-externo-e-a-palavra-temperada">
            4. O Testemunho Externo e a Palavra Temperada
          </H3>
          <P className="">
          ...
          <P className="">
            ...
            e deve deixar bem claro para todo mundo que nasceu de novo e ter a
            resposta certa quando questionarem a sua fé.
          </P>
          <P className="">
        ...
        <div className="flex flex-col gap-4">
          ...
          <P className="">
            Nesta lição, aprendemos que precisamos refletir Cristo em todas as
            áreas de nossa vida, começando em casa, passando pelo trabalho e
            finalizando na igreja. Saiba de uma coisa: a partir do momento em
            que tomamos a decisão de seguir Cristo, o mundo começa a nos
            analisar, nos observar e nos tem como exemplo de cristãos, seja bom
            ou ruim.
          </P>
          <P className="">
            Temos livre acesso ao PAI, através da oração, onde podemos conversar
            com ELE livremente, sem rodeios, e clamar para que nos ajude na
            caminhada da vida, sempre prontos para auxiliar os que nos pedem
            ajuda.
          </P>
          <P className="">
            É fato: se você é seguidor de Cristo, aceitou-O como único e
            suficiente Salvador, você se tornou templo do Espírito Santo, uma
            nova criatura, filho de Deus.
          </P>
          <P className="">
      ...
      <Container className="mb-10 sm:mb-16">
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col">
            <P className="mt-0">
              <span className="font-semibold">Curso:</span> Carta aos
              Colossenses
            </P>
            <P className="mt-0">
          ...
          <div className="flex flex-col">
            ...
            <P className="mt-0">Lição 1 – Pr. Marco Antônio</P>
            <P className="mt-0">Lição 2 – Hemerson Dantas</P>
            <P className="mt-0">Lição 3 – Pr. Anderson Silva</P>
            <P className="mt-0">Lição 4 – Pr. Oziel Barros</P>
            <P className="mt-0">Lição 5 – Marcelo Brito</P>
          </div>
        </div>
      </Container>
    </section>
