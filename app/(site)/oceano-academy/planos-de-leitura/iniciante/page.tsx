...
import beginner from "~/data/reading-plans/beginner.json";
...
export default function IniciantePage() {
  const readingPlan = beginner as ReadingPlan;
    ...
    <section className="relative backdrop-blur-sm">
      ...
      <HeroContainer className="pb-2 sm:pb-0 mb-10 sm:mb-16">
        <div className="flex flex-col gap-2">
          <H1 className="text-left">Iniciante</H1>
          <P className="mt-0">Panorama Bíblico, para iniciantes.</P>
        </div>
        ...
        <Table className="">
          <TableHeader>
            ...
            <TableRow className="">
              ...
              <TableCell>7 horas e 19 minutos</TableCell>
            </TableRow>
          </TableHeader>
        </Table>
      </HeroContainer>
