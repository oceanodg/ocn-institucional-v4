...
import newTestament from "~/data/reading-plans/new-testament.json";
...
export default function NovoTestamentoPage() {
  const readingPlan = newTestament as ReadingPlan;
    ...
    <section className="relative backdrop-blur-sm">
      ...
      <HeroContainer className="pb-2 sm:pb-0 mb-10 sm:mb-16">
        <div className="flex flex-col gap-2">
          <H1 className="text-left">Novo Testamento</H1>
          <P className="mt-0">Novo Testamento em 90 dias.</P>
        </div>
