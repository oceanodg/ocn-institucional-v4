...
import chronologicalNewTestament from "~/data/reading-plans/chronological-new-testament.json";
...
export default function NovoTestamentoOrdemCronologicaPage() {
  const readingPlan = chronologicalNewTestament as ReadingPlan;
    ...
    <section className="relative backdrop-blur-sm">
      ...
      <HeroContainer className="pb-2 sm:pb-0 mb-10 sm:mb-16">
        <div className="flex flex-col gap-2">
          <H1 className="text-left">Novo Testamento em Ordem Cronológica</H1>
          <P className="mt-0">
            Novo Testamento na ordem que os eventos aconteceram.
          </P>
        </div>
        ...
        <Table className="">
          <TableHeader>
            <TableRow className="">
              ...
              <TableCell className="border">Novo Testamento</TableCell>
            </TableRow>
            <TableRow className="">
              <TableCell className="border font-bold">Dias</TableCell>
              <TableCell>92 Dias</TableCell>
            </TableRow>
            <TableRow className="">
              <TableCell className="border font-bold">
                Tempo de Leitura
              </TableCell>
              <TableCell>22 horas e 6 minutos</TableCell>
            </TableRow>
          </TableHeader>
        </Table>
      </HeroContainer>
