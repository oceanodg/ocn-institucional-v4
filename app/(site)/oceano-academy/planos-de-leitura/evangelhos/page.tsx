...
import gospels from "~/data/reading-plans/gospels.json";
...
export default function EvangelhosPage() {
  const readingPlan = gospels as ReadingPlan;
    ...
    <section className="relative backdrop-blur-sm">
      ...
      <HeroContainer className="pb-2 sm:pb-0 mb-10 sm:mb-16">
        <div className="flex flex-col gap-2">
          <H1 className="text-left">Evangelhos</H1>
          <P className="mt-0">Vida e ministério do Senhor Jesus Cristo.</P>
        </div>
