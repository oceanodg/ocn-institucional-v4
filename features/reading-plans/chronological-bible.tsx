...
import chronologicalBible from "./data/chronological-bible.json";
...
export function ReadingPlanChronologicalBible() {
  const readingPlan = chronologicalBible as ReadingPlan;
    ...
    <section className="relative backdrop-blur-sm">
      ...
      <HeroContainer className="pb-2 sm:pb-0 mb-10 sm:mb-16">
        <div className="flex flex-col gap-2">
          <H1 className="text-left">Ordem Cronológica</H1>
          <P className="mt-0">
            Leia a Bíblia na ordem que os eventos aconteceram.
          </P>
        </div>
        ...
        <Table className="">
          <TableHeader>
            ...
            <TableRow className="">
              ...
              <TableCell>98 horas e 18 minutos</TableCell>
            </TableRow>
          </TableHeader>
        </Table>
      </HeroContainer>
